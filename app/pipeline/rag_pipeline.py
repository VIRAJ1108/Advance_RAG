...
class RAGPipeline:
    ...
    def load_pdf_from_path(self, pdf_path):
...
"""
    ...
    """
        ...
        # return {"answer": final_answer}   ORIGINAL CODE 

        return {"answer": answer, "contexts": [doc.page_content for doc in docs]}  ## modified for RAGAS
